...
supply_sort(zombie_apocalypse_supplies)
...
item_included?("knife", zombie_apocalypse_supplies)
item_included?("rations", zombie_apocalypse_supplies)
...
combine_arrays(zombie_apocalypse_supplies, other_survivor_supplies)
